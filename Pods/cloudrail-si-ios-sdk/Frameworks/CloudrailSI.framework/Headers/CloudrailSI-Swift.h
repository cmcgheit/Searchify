...
- (NSMutableArray * _Nullable)searchWithQuery:(NSString * _Nonnull)query error:(NSError * _Nullable * _Nullable)error SWIFT_WARN_UNUSED_RESULT;
...
- (nonnull instancetype)initWithBotToken:(NSString * _Nonnull)botToken OBJC_DESIGNATED_INITIALIZER;
- (CRMessage * _Nullable)sendMessageTo:(NSString * _Nonnull)receiverId message:(NSString * _Nonnull)message error:(NSError * _Nullable * _Nullable)error SWIFT_WARN_UNUSED_RESULT;
- (CRMessage * _Nullable)sendImageTo:(NSString * _Nonnull)receiverId message:(NSString * _Nonnull)message imageId:(NSString * _Nonnull)imageId imageStream:(NSInputStream * _Nonnull)imageStream previewUrl:(NSString * _Nonnull)previewUrl error:(NSError * _Nullable * _Nullable)error SWIFT_WARN_UNUSED_RESULT;
- (CRMessage * _Nullable)sendVideoTo:(NSString * _Nonnull)receiverId message:(NSString * _Nonnull)message videoId:(NSString * _Nonnull)videoId videoStream:(NSInputStream * _Nonnull)videoStream previewUrl:(NSString * _Nonnull)previewUrl size:(long)size error:(NSError * _Nullable * _Nullable)error SWIFT_WARN_UNUSED_RESULT;
- (CRMessage * _Nullable)sendAudioTo:(NSString * _Nonnull)receiverId message:(NSString * _Nonnull)message audioId:(NSString * _Nonnull)audioId audioStream:(NSInputStream * _Nonnull)audioStream previewUrl:(NSString * _Nonnull)previewUrl audioName:(NSString * _Nonnull)audioName size:(long)size error:(NSError * _Nullable * _Nullable)error SWIFT_WARN_UNUSED_RESULT;
...
- (NSMutableArray * _Nullable)processWebhookRequest:(NSInputStream * _Nonnull)httpRequest error:(NSError * _Nullable * _Nullable)error SWIFT_WARN_UNUSED_RESULT;
- (CRMessagingAttachment * _Nullable)downloadContent:(CRMessagingAttachment * _Nonnull)attachment error:(NSError * _Nullable * _Nullable)error SWIFT_WARN_UNUSED_RESULT;
- (CRAdvancedRequestResponse * _Nullable)advancedRequest:(CRAdvancedRequestSpecification * _Nonnull)specification error:(NSError * _Nullable * _Nullable)error SWIFT_WARN_UNUSED_RESULT;
- (NSString * _Nullable)saveAsStringAndReturnError:(NSError * _Nullable * _Nullable)error SWIFT_WARN_UNUSED_RESULT;
- (BOOL)loadAsString:(NSString * _Nonnull)savedState error:(NSError * _Nullable * _Nullable)error;
- (void)useAdvancedAuthentication;
...
- (nonnull instancetype)initWithBotToken:(NSString * _Nonnull)botToken webhook:(NSString * _Nonnull)webhook OBJC_DESIGNATED_INITIALIZER;
- (CRMessage * _Nullable)sendMessageTo:(NSString * _Nonnull)receiverId message:(NSString * _Nonnull)message error:(NSError * _Nullable * _Nullable)error SWIFT_WARN_UNUSED_RESULT;
- (CRMessage * _Nullable)sendImageTo:(NSString * _Nonnull)receiverId message:(NSString * _Nonnull)message imageId:(NSString * _Nonnull)imageId imageStream:(NSInputStream * _Nonnull)imageStream previewUrl:(NSString * _Nonnull)previewUrl error:(NSError * _Nullable * _Nullable)error SWIFT_WARN_UNUSED_RESULT;
- (CRMessage * _Nullable)sendVideoTo:(NSString * _Nonnull)receiverId message:(NSString * _Nonnull)message videoId:(NSString * _Nonnull)videoId videoStream:(NSInputStream * _Nonnull)videoStream previewUrl:(NSString * _Nonnull)previewUrl size:(long)size error:(NSError * _Nullable * _Nullable)error SWIFT_WARN_UNUSED_RESULT;
- (CRMessage * _Nullable)sendAudioTo:(NSString * _Nonnull)receiverId message:(NSString * _Nonnull)message audioId:(NSString * _Nonnull)audioId audioStream:(NSInputStream * _Nonnull)audioStream previewUrl:(NSString * _Nonnull)previewUrl audioName:(NSString * _Nonnull)audioName size:(long)size error:(NSError * _Nullable * _Nullable)error SWIFT_WARN_UNUSED_RESULT;
