...
class CategoryCollectionViewCell: UICollectionViewCell {
    ...
    override func prepareForReuse() {
        ...
        genreLabel.text = nil
        genreImageView.image = UIImage(systemName: "music.quarternote.3", withConfiguration: UIImage.SymbolConfiguration(pointSize: 50, weight: .regular))
    }
    ...
    func configure(with viewModel: CategoryViewModel) {
            ...
            genreImageView.sd_setImage(with: viewModel.artworkURL, completed: nil)
