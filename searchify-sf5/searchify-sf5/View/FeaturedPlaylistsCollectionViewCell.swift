...
class FeaturedPlaylistsCollectionViewCell: UICollectionViewCell {
    ...
    static let identifier = "FeaturedPlaylistsCollectionCell"
    ...
    func configure(with viewModel: FeaturedPlaylistViewModel) {
        ...
        playlistCoverImageView.sd_setImage(with: viewModel.artworkURL, placeholderImage: UIImage(named: "default-placeholder-green"), completed: nil)
